...
int main(int argc, char* argv[]) {
    ...
    backgroundTextures.push_back(loadTexture("./Assets/Pixel_Forest/layer33.png"));
    backgroundTextures.push_back(loadTexture("./Assets/Pixel_Forest/layer34.png"));
    backgroundTextures.push_back(loadTexture("./Assets/Pixel_Forest/layer35.png"));
